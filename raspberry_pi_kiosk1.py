...
# Configuration
UPLOAD_URL = "http://localhost:5000"  # Your Flask backend URL
PRINTER_NAME = "HP_LaserJet_M208dw"  # Your printer name in CUPS
QR_URL = "https://yourproject.lovable.app"  # Your web app URL
...
class PrintKiosk:
    ...
    def show_welcome(self):
        ...
        instructions = tk.Label(
            self.container,
            text="Or upload from this device using the touchscreen",
            font=('Arial', 18),
            bg='#1a1a2e',
            fg='#94a3b8'
        )
